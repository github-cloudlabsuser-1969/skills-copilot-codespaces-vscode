...
-- update the customer_phone of the customer with customer_id 1 to '111-222-3333'
UPDATE customers
SET customer_phone = '111-222-3333'
WHERE customer_id = 1;
-- delete the customer with customer_id 2
DELETE FROM customers
WHERE customer_id = 2;
-- select all records from the customers table
SELECT * FROM customers;
-- create a table with 5 coloumns order_id, customer_id, order_date, order_amount, order_status